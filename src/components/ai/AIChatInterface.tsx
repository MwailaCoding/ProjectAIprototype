    ...
    <div className="p-4 border-t border-slate-700">
      <div className="flex space-x-2">
        ...
        <button
          ...
          className="bg-cyan-500 text-white px-6 py-2 rounded-lg hover:bg-cyan-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2"
        >
